...
class ApiWrapper {
  constructor (attrs, registryMockAsSecondArg) {
    ...
    const belongsToDescriptors = this.relations.belongsToDescriptors
    const hasManyDescriptors = this.relations.hasManyDescriptors
    ...
    if (serializer) {
      ...
      this.serializer = new Serializer({
        ...
        attributesOfRelations: attributesOfRelations(this.registry, belongsToDescriptors, hasManyDescriptors)
      })
    }
    ...
    if (deserializer) {
      ...
      const modelNamesOfRelations = belongsToDescriptors
