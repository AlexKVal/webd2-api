...
class SqlBuilder {
  constructor (descriptors) {
    this.idFieldName = descriptors.id || 'id'
    this.idFieldClause = descriptors.id ? `${descriptors.id} as id` : 'id'
  ...
  generateSelectFieldsPart (fieldsOnly) {
    ...
    return idFieldPart.concat(columnsNames, this._generateForeignKeysLines()).join(', ')
  }
