...
class User extends BaseModel {
  // TODO remove it after 'relationsConstraints: {}' feature is implemented
  selectMany (options) {
    options = Object.assign({where: {hide: false}, orderBy: 'name'}, options)
    return super.selectMany(options)
  }
