...
class BaseModel {
  ...
  apiFetchAll (options) {
    ...
    .then((dataSet) => {
      if (options.withRelated) {
        return this.serializer.serializeWithRelated(dataSet)
      } else {
        return this.serializer.serializeWithoutRelated(dataSet)
      }
    })
  }
  ...
  _joinRelationsAndSerialize (records) {
    ...
    return this.serializer.serializeWithoutRelated(dataSet[0])
  }
