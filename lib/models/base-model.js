...
class BaseModel {
  ...
  apiFetchAll (options) {
    ...
    .then((parentRows) => {
      if (options.withRelated) {
        ...
        return this._replaceRelIDsByRelations(parentRows)
      }
    })
    .then((dataSet) => {
      if (options.withRelated) {
  ...
  _fetchBelongsToRelations (parentRows) {
    ...
    .then((relationsData) => this._replaceRelIDsByRelations(parentRows, relationsData))
  }

  _replaceRelIDsByRelations (parentRows, relations) {
    relations = relations || this.schema.belongsToRelations
  ...
  _castJoinAndSerialize (records) {
    const parentRows = castTypesRows(records, this.schema)
    return this._joinRelationsAndSerialize(parentRows)
  }

  _joinRelationsAndSerialize (records) {
    const dataSet = this._replaceRelIDsByRelations(records)
  ...
  apiFind (id) {
    ...
    return this.get(id)
    .then((records) => this._joinRelationsAndSerialize(records, this.schema))
  }
  ...
  apiCreate (newData) {
    ...
    .then((record) => this._castJoinAndSerialize([record], this.schema))
  }
  ...
  serialize (records) {
    ...
    return this.serializerWithoutRelated.serialize(castTypesRows(records, this.schema))
  }
